        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.CharField(
                        default="", max_length=254, verbose_name="structure name"
                    ),
                ),
                (
                    "timer_type",
                ...
                (
                    "system",
                    models.CharField(
                        default="", max_length=254, verbose_name="solar system name"
                    ),
                ),
                (
                    "planet_moon",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=None,
                        help_text="URL to a screenshot of the structure's fitting, e.g. https://www.example.com/route/image.jpg",
                        max_length=1024,
                        null=True,
                    ),
                ),
            ...
            options={
                "permissions": (
                    ("view_opsec_timer", "Can view timers marked as opsec"),
                ),
            },
        ),
    ]
