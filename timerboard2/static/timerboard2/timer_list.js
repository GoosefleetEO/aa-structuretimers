$(document).ready(function(){
    ...
    $('#modalFitting').on('show.bs.modal', function (event) {
        ...
        $.get(
            ...
            function(timer, status){                        
                modal
                    .find('.modal-title')
                    .text(`Timer details for: ${timer['structure_display_name']}`);
                modal
                    .find('.modal-body img')
                    .attr("src", timer['fitting_image_url']);
                modal
                    .find('.modal-body a')
                    .attr("href", timer['fitting_image_url']);
                modal
