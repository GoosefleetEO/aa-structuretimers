# Generated by Django 2.2.13 on 2020-08-06 19:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('minutes', models.PositiveIntegerField(choices=[(0, '0'), (5, '5'), (10, '10'), (15, '15'), (30, '30'), (45, '45'), (60, '60'), (120, '120')], db_index=True, help_text='Time before event in minutes when notifications are sent')),
                ...
                ('require_alliances', models.ManyToManyField(blank=True, help_text='Timer must be created by one of the given alliances or leave blank to match any.', to='eveonline.EveAllianceInfo')),
                ('require_corporations', models.ManyToManyField(blank=True, help_text='Timer must be created by one of the given corporations or leave blank to match any.', to='eveonline.EveCorporationInfo')),
                ('webhooks', models.ManyToManyField(help_text='Webhooks notifications are sent to', to='structuretimers.DiscordWebhook')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timer_type', models.CharField(choices=[('NO', 'Unspecified'), ('AR', 'Armor'), ('HL', 'Hull'), ('FI', 'Final'), ('AN', 'Anchoring'), ('UA', 'Unanchoring'), ('MM', 'Moon Mining')], default='NO', max_length=2, verbose_name='timer type')),
